use crate::{
    api::{
        ...
        delete_registration, delete_user, get_all_users, get_committee, get_committee_members,
        get_committees, get_event, get_event_registrations, get_events, get_file_content,
